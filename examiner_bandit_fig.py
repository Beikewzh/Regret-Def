...
ax[0].plot(rho_s, lw=2, label=r"examiner regret $\sum\rho_t$ (ours, valid bound)")
ax[0].plot(rho_b, "--", lw=2, label=r"plug-in standard regret (underestimates)")
...
ax[1].plot(np.cumsum(rho_s), lw=2, label=r"examiner regret $\sum\rho_t$ (ours, valid bound)")
ax[1].plot(np.cumsum(rho_b), "--", lw=2, label=r"plug-in standard regret (underestimates)")
