...
\begin{abstract}
Continual reinforcement learning considers an agent receiving and learning from a stream of experience. The agent only learns about its world through these experiences and aims to maximize its accumulated. A natural problem is to evaluate this agent, using only its stream of experience, without assuming a particular structure of the world.
We define 
