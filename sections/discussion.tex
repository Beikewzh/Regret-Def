...
If we view the agent as part of the world \citep{lewandowski2025bigger}, so that the world has access to the agent's policy (and learning algorithm), we can view the world as an examiner that outputs $\Vlow_t =V^\pi_t$ and $\Vhi =V^*_t$.
